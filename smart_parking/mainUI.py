...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayoutWidget.setGeometry(QtCore.QRect(50, 180, 331, 331))
        ...
        self.gridLayoutWidget_2.setGeometry(QtCore.QRect(560, 180, 331, 331))
        ...
        self.statusLabel.setGeometry(QtCore.QRect(30, 140, 361, 31))
        ...
        self.ansLabel.setGeometry(QtCore.QRect(680, 140, 91, 31))
        ...
        self.countLabel.setGeometry(QtCore.QRect(660, 20, 281, 41))
        self.countLabel.setObjectName("countLabel")
        self.manualLabel = QtWidgets.QLabel(self.centralwidget)
        self.manualLabel.setGeometry(QtCore.QRect(410, 20, 131, 41))
        self.manualLabel.setAlignment(QtCore.Qt.AlignCenter)
        self.manualLabel.setObjectName("manualLabel")
        self.egLabel = QtWidgets.QLabel(self.centralwidget)
        self.egLabel.setGeometry(QtCore.QRect(30, 30, 311, 31))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.countLabel.setText(_translate("MainWindow", " Swap Counts: 0"))
        self.manualLabel.setText(_translate("MainWindow", "手動模式"))
        self.egLabel.setText(_translate("MainWindow", "Target: 3, Obstacle: 2"))
